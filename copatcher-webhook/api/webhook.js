...
async function sendSaleNotification(customerEmail, customerName, amount, currency, date) {
  const msg = {
    to: '279sdh@gmail.com', // Your email
    from: 'copat@copatcher.com',
    ...
    html: `
      <div style="background: linear-gradient(45deg, #0e1117, #1e2a3a); color: #e0e0e0; padding: 30px; border-radius: 15px; font-family: Arial, sans-serif;">
        ...
        <hr style="border: 1px solid #58a6ff; margin: 30px 0;">
        
        <p style="text-align: center; color: #c9d1d9; font-size: 14px;">
          This email was automatically generated by your webhook system.<br>
          Want to check Stripe dashboard? Visit: dashboard.stripe.com
        </p>
      </div>
    `
  };
